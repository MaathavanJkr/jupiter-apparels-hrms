...
import {createLeaveApplication} from  "../../services/leaveServices.ts";
import {notifyError, notifySuccess} from "../../services/notify.ts";
...
const UpdateLeaveApplicationData = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      notifyError("Could Create Application");
        ...
        <div className=" w-full h-screen flex items-center justify-center">
          <div className="w-[50%] h-[90%] bg-gray-300 p-6 rounded-lg shadow-lg dark:bg-blue-950">
            ...
            <div className="mt-7 flex justify-normal">
              <button onClick={handleSubmit} className="shadow-lg m-2 rounded-lg bg-blue-700 card-btn font-bold text-black self-center hover:bg-green-500 dark:text-white">
                Submit
              </button>
