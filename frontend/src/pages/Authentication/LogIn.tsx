...
// import backgroundImage from '../../images/9387.jpg';
...
//         <div className=" mt-25 flex flex-wrap items-center">
//           <div className="hidden w-full xl:block xl:w-1/2">
//             <div className="py-17.5 px-26 text-center">
//               <Link className="mb-5.5 inline-block" to="/">
//                 <h1 className='text-5xl text-blue-950 font-bold' >Jupiter Apparels</h1>
//               </Link>
  ...
  <div className="flex flex-wrap items-center h-full">
    <div style={{
      ...
      <div className="py-17.5 px-26 text-center relative z-10"> 
        <Link className="mb-5.5 inline-block" to="/">
          <h1 className="mt-40 text-7xl text-white text-w font-bold">Jupiter Apparels</h1>
        </Link>
        <p className="text-xl mt-5 text-white">
          Your gateway to seamless workforce management, empowering over 1000 employees across our global network
        </p>
      </div>
    </div>
