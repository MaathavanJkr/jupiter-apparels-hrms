...
import { getEmployeesByDepartmentIDModel, getTotalLeavesByDepartmentForPeriodModel } from "../models/report.model";
...
export const getTotalLeavesByDepartmentForPeriod = async (
    ...
    if (!start_date || !end_date || !validateDateString(start_date) || !validateDateString(end_date)) {
